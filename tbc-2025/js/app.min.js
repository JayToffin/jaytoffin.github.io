...
lenis.on("scroll", ScrollTrigger.update), gsap.ticker.add((e => {
    ...
    gsap.timeline({
        scrollTrigger: {
            trigger: ".pinned-fullscreen__tl-trigger",
            start: "top 80%",
            end: "top 10%",
            scrub: {
                scrub: !0,
    ...
    $("img, a").on("dragstart", (function (e) {
    ...
    })), $(".nav__wrap").each((function () {
        let e = $(this).find(".nav__hamburger"),
            t = $(this).find(".hamburger__line"),
            a = $(this).find(".menu__contain"),
            r = $(this).find(".hamburger__base"),
            o = $(this).find(".menu__wrapper"),
            n = $(this).find(".menu__base"),
            i = ($(this).find(".menu__link"), $(this).find(".main-menu__item")),
        ...
        $(".nav__hamburger").hasClass("nav-open") ? $(".header").addClass("menu-is-visible") : setTimeout((function () {
    ...
    }, new e($("#main-menu"), !1), $(".projects-masonry__gallery").imagesLoaded().progress((function () {
        $(".projects-masonry__gallery").masonry("layout"), ScrollTrigger.refresh()
    })), $(".accordion__title").on("click", (function (e) {
        e.preventDefault();
        var t = $(this);
        t.hasClass("accordion-active") || ($(".accordion__content").slideUp(400), $(".accordion__title").removeClass("accordion-active"), $(".accordion__arrow").removeClass("accordion-rotate")), t.toggleClass("accordion-active"), t.next().slideToggle(), $(".accordion__arrow", this).toggleClass("accordion-rotate")
...
new Ukiyo(images, {
    ...
    speed: 1.5,
    externalRAF: !1
}), $(".pinned").each((function (e) {
    let t = $(this).find(".pinned__text-item"),
        a = $(this).find(".pinned__img-item");
...
const innerDemoSlider = document.querySelector("demo-swiper");
innerDemoSlider || new Swiper(".demo-swiper", {
    breakpoints: {
        640: {
            slidesPerView: 1,
            spaceBetween: 30
